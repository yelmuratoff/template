...
///
/// In some cases we want to wrap our screen with a parent widget usually
/// to provide some values through context,
/// e.g wrapping your route with a custom Theme or a Provider,
/// to do that simply implement AutoRouteWrapper,
/// and have wrappedRoute(context) method return (this)
/// as the child of your wrapper widget
///
